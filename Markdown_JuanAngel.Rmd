...
library(ggplot2)
ggplot(movies_grouped, aes(x = actorsAmount, y = mean_revenue)) + 
  geom_col() + 
  xlab("Cantidad de actores") + 
  ylab("Media de ingresos (en millones)") + 
  ggtitle("Relación entre la cantidad de actores y los ingresos de las películas")

```

### 4.8 ¿Se han hecho  películas con más actores en los últimos años? 
